...
public class AudioMediaCodec {
    ...
    public static MediaCodec getAudioMediaCodec() {
        try {
            ...
            e.printStackTrace();
            LogUtils.d("AudioMediaCodec initial error...");
        }
